...
if __name__ == "__main__":  
    ...
    data_config = sagemaker.clarify.DataConfig(
        ...
        label=0,
        headers=[
            'target','esent','eopenrate','eclickrate','avgorder','ordfreq','paperless','refill','doorstep',
            ...
            'city_BLR','city_BOM','city_DEL','city_MAA'
        ],
    ...
    analysis_config["methods"] = {
        ...
        "shap": {
            "baseline": f"s3://{args.default_bucket}/input/baseline/baseline.csv",
    ...
    analysis_config_file = os.path.join(base_dir, "analysis_config.json")
    ...
    s3_client.Bucket(args.default_bucket).upload_file(
        analysis_config_file, "clarify-output/bias/analysis_config.json"
    )
